...
export const pageSeo: Record<string, SeoConfig> = {
  ...
  "managed-services": {
    title: "Managed Services - Proactive IT Infrastructure Management - HostingSol",
  ...
  colocation: {
    title: "Colocation Services - Enterprise Data Center Solutions - HostingSol",
...
export function generateMetadata(
  ...
  const mergedSeo = { ...seoData, ...customSeo };

  return {
    title: mergedSeo.title,
    description: mergedSeo.description,
    keywords: mergedSeo.keywords,
    metadataBase: new URL("https://hostingsol.in"),
    alternates: {
      canonical: mergedSeo.canonical || "https://hostingsol.in",
    },
    openGraph: {
      title: "Page Title",
    ...
    authors: [{ name: "HostingSol" }],
    publisher: "HostingSol",
    formatDetection: {
      email: false,
      address: false,
      telephone: false,
